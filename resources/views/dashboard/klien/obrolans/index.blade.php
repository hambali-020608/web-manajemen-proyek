<x-dashboard-layout>
    @php
        $kliens = auth('kliens')->user()->load('proyek');
        // dd($kliens->proyek)
        $proyeks = $kliens->proyek
    @endphp
        ...
        <div class="mt-6 border-t border-gray-200 pt-4">
            <form class="flex items-center space-x-2">
                <div class="flex-grow relative">
                    <input type="text" placeholder="Type your message..." class="w-full px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
